...
This driver is written for usage with the ESP8266 and FreeRTOS (esp-open-rtos) using the I2C interface driver. It supports multiple SHT3x sensors connected to the same or different I2C interfaces.

The driver is also working with ESP32 and ESP-IDF using a wrapper for ESP8266 function, see folder ```components/esp8266_wrapper```.
